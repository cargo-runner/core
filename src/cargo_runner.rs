      ...
      pub mod types {
        ...
        unsafe impl _rt::WasmResource for Engine{
          ...
          unsafe fn drop(_handle: u32) {
            ...
            {
              #[link(wasm_import_module = "[export]vscode:extensions/types")]
              extern "C" {
...
macro_rules! __export_vscode_extensions_types_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

    #[export_name = "vscode:extensions/types#[constructor]engine"]
    ...
    #[export_name = "vscode:extensions/types#[method]engine.push-operand"]
    ...
    #[export_name = "vscode:extensions/types#[method]engine.push-operation"]
    ...
    #[export_name = "vscode:extensions/types#[method]engine.execute"]
    ...
    const _: () = {
      #[doc(hidden)]
      #[export_name = "vscode:extensions/types#[dtor]engine"]
      #[allow(non_snake_case)]
...
#[doc(hidden)]
pub(crate) use __export_vscode_extensions_types_cabi;
...
macro_rules! __export_cargo_runner_impl {
  ($ty:ident) => (self::export!($ty with_types_in self););
  ($ty:ident with_types_in $($path_to_types_root:tt)*) => (
  $($path_to_types_root)*::exports::vscode::extensions::types::__export_vscode_extensions_types_cabi!($ty with_types_in $($path_to_types_root)*::exports::vscode::extensions::types);
  )
}
#[doc(inline)]
pub(crate) use __export_cargo_runner_impl as export;

#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.34.0:vscode:extensions:cargo-runner:encoded world"]
#[doc(hidden)]
...
\x08\x04\0\x17vscode:extensions/types\x05\0\x04\0\x1evscode:extensions/cargo-run\
ner\x04\0\x0b\x12\x01\0\x0ccargo-runner\x03\0\0\0G\x09producers\x01\x0cprocessed\
-by\x02\x0dwit-component\x070.219.1\x10wit-bindgen-rust\x060.34.0";
